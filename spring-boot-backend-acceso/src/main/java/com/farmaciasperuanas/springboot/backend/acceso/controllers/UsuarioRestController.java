...
import com.farmaciasperuanas.springboot.backend.acceso.models.services.IUsuarioService;
...
public class UsuarioRestController {
	...
	public ResponseEntity<?> update(@RequestBody Usuario usuario, @PathVariable Long id) {
		...
		try {
			...
			usuarioActual.setNom_usuario(usuario.getNom_usuario());
			usuarioActual.setApe_usuario(usuario.getApe_usuario());
			usuarioActual.setDni_usuario(usuario.getDni_usuario());
			usuarioActual.setEma_usuario(usuario.getEma_usuario());
